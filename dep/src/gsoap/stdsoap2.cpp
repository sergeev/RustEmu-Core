...
{ char tmp[8];
  ...
  *s = '\0';
  if (*tmp == '#')
  { if (tmp[1] == 'x' || tmp[1] == 'X')
      return soap_strtol(tmp + 2, nullptr, 16);
    return atol(tmp + 1);
  }
  if (!strcmp(tmp, "lt"))
    return '<';
...
soap_gethex(struct soap *soap, int *n)
{
  ...
  for (;;)
  { int i;
    char *s = (char*)soap_push_block(soap, nullptr, SOAP_BLKLEN);
    if (!s)
...
soap_getbase64(struct soap *soap, int *n, int /*malloc_flag*/)
{
  ...
  for (;;)
  { int i;
    char *s = (char*)soap_push_block(soap, nullptr, 3 * SOAP_BLKLEN); /* must be multiple of 3 */
    if (!s)
    { soap_end_block(soap, nullptr);
      return nullptr;
    }
...
{ /* Check MTOM xop:Include element (within hex/base64Binary) */
  ...
  { if (!soap_element_begin_in(soap, "xop:Include", 0, nullptr) && *soap->href)
    { if (soap_dime_forward(soap, ptr, size, id, type, options))
        return soap->error;
    }
    if (soap->body && soap_element_end_in(soap, nullptr))
      return soap->error;
  }
  soap->body = body;
  return SOAP_OK;
...
#endif
#ifndef WITH_LEANER
  soap->fprepareinit = nullptr;
  soap->fpreparesend = nullptr;
  soap->fpreparerecv = nullptr;
  soap->fpreparefinal = nullptr;
#endif
  ...
  if (!soap_tag_cmp(endpoint, "https:*"))
  {
    ...
    { soap_mode m = soap->mode; /* preserve settings */
      ...
      if (soap_begin_send(soap)
       || (soap->error = soap->fposthdr(soap, soap->tmpbuf, nullptr)))
      { soap->fclosesocket(soap, fd);
        return SOAP_INVALID_SOCKET;
      }
#ifndef WITH_LEAN
...
#endif
      if ((soap->error = soap->fposthdr(soap, nullptr, nullptr))
       || soap_flush(soap))
      { soap->fclosesocket(soap, fd);
        return SOAP_INVALID_SOCKET;
      }
...
/* Use soap->host to store the numeric form of the remote host */
        getnameinfo((struct sockaddr*)&soap->peer, n, soap->host, sizeof(soap->host), nullptr, 0, NI_NUMERICHOST | NI_NUMERICSERV);
...
{ soap->state = SOAP_INIT;
  ...
  soap->ipv4_multicast_if = nullptr;
#ifndef WITH_IPV6
  soap->fresolve = tcp_gethost;
#else
  soap->fresolve = nullptr;
...
{
#ifdef WITH_DOM
  struct soap_dom_attribute **att = nullptr;
  char *lead = nullptr;
#endif
...
{ struct Namespace *p;
  ...
  { if (soap->error == SOAP_TAG_MISMATCH
     && !soap_element_begin_in(soap, "Envelope", 0, nullptr))
...
{ soap->part = SOAP_IN_BODY;
  ...
  if ((soap->mode & SOAP_XML_SEC) && soap_set_attr(soap, "wsu:Id", "Body"))
    return soap->error;
#endif
  if (soap_element(soap, "SOAP-ENV:Body", 0, nullptr))
    return soap->error;
  return soap_element_start_end_out(soap, nullptr);
}
#endif
