...
void zipRead(const std::string& file, void*& data, size_t& length) {
    std::string zip, desiredFile;

    (void) file; (void) length;
...
bool zipfileExists(const std::string& filename, std::string& outZipfile,
                   std::string& outInternalFile){
  (void) filename; (void) outZipfile; (void) outInternalFile;
...
static void getFileOrDirListZip(const std::string& path,
                                ...
                                bool wantFiles,
                                bool includePath){
  (void)path; (void)prefix; (void)files; (void)wantFiles; (void)includePath;
