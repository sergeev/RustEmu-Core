...
UPDATE creature_template SET NpcFlags = 0 WHERE entry = 37187;
DELETE FROM creature WHERE id = 37187;
INSERT INTO creature (guid,id,map,spawnMask,phaseMask,modelid,equipment_id,position_x,position_y,position_z,orientation,spawntimesecs,spawndist,currentwaypoint,curhealth,curmana,DeathState,MovementType) VALUES
(600028, 37187, 631, 15, 64, 0, 0, -48.9097, 2211.06, 27.9859, 3.15905, 7200, 0, 0, 4183500, 0, 0, 0);

-- Muradin Bronzebeard
UPDATE creature_template SET NpcFlags = 0 WHERE entry = 37200;
DELETE FROM creature WHERE id = 37200;
INSERT INTO creature (guid,id,map,spawnMask,phaseMask,modelid,equipment_id,position_x,position_y,position_z,orientation,spawntimesecs,spawndist,currentwaypoint,curhealth,curmana,DeathState,MovementType) VALUES
(600029, 37200, 631, 15, 128, 0, 0, -48.9097, 2211.06, 27.9859, 3.15905, 7200, 0, 0, 4183500, 0, 0, 0);
