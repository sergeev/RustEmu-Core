...
ChatCommand* ChatHandler::getCommandTable()
{
    ...
    {
        { "add"  ,          SEC_ADMINISTRATOR,  true,  &ChatHandler::HandleAccountFriendAddCommand,    "", nullptr },
        { "delete",         SEC_ADMINISTRATOR,  true,  &ChatHandler::HandleAccountFriendDeleteCommand, "", nullptr },
        { "list",           SEC_ADMINISTRATOR,  true,  &ChatHandler::HandleAccountFriendListCommand,   "", nullptr },
        { nullptr,             0,                  false, nullptr,                                           "", nullptr }
    };
    ...
    static ChatCommand accountCommandTable[] =
    {
        ...
        { "friend",         SEC_ADMINISTRATOR,  true,  nullptr,                                           "", accountFriendCommandTable },
    ...
    static ChatCommand characterCommandTable[] =
    {
        ...
        { "changefaction",  SEC_ADMINISTRATOR,  true,  &ChatHandler::HandleCharacterChangeFactionCommand, "", nullptr },
        { "changerace",     SEC_ADMINISTRATOR,  true,  &ChatHandler::HandleCharacterChangeRaceCommand, "", nullptr },
    ...
    static ChatCommand debugSendCommandTable[] =
    {
        ...
        { "calendarresult", SEC_ADMINISTRATOR,  false, &ChatHandler::HandleDebugSendCalendarResultCommand,  "", nullptr },
        { nullptr,             0,                  false, nullptr,                                                "", nullptr }
    };
    ...
    static ChatCommand debugCommandTable[] =
    {
        ...
        { "entervehicle",   SEC_GAMEMASTER,     false, &ChatHandler::HandleDebugEnterVehicleCommand,        "", nullptr },
        { nullptr,             0,                  false, nullptr,                                                "", nullptr }
    };
    ...
    {
        { "list",           SEC_GAMEMASTER,     false, &ChatHandler::HandleWorldStateListCommand,      "", nullptr },
        { "global",         SEC_GAMEMASTER,     false, &ChatHandler::HandleWorldStateListAllCommand,   "", nullptr },
        { "add",            SEC_ADMINISTRATOR,  false, &ChatHandler::HandleWorldStateAddCommand,       "", nullptr },
        { "update",         SEC_ADMINISTRATOR,  false, &ChatHandler::HandleWorldStateUpdateCommand,    "", nullptr },
        { "reload",         SEC_ADMINISTRATOR,  false, &ChatHandler::HandleWorldStateReloadCommand,    "", nullptr },
        { "",               SEC_GAMEMASTER,     false, &ChatHandler::HandleWorldStateCommand,          "", nullptr },
        { nullptr,             0,                  false, nullptr,                                           "", nullptr }
    };

    static ChatCommand transportCommandTable[] =
    {
        { "list",           SEC_ADMINISTRATOR,  false, &ChatHandler::HandleTransportListCommand,       "", nullptr },
        { "current",        SEC_ADMINISTRATOR,  false, &ChatHandler::HandleTransportCurrentCommand,    "", nullptr },
        { "path",           SEC_ADMINISTRATOR,  false, &ChatHandler::HandleTransportPathCommand,       "", nullptr },
        { "go",             SEC_ADMINISTRATOR,  false, &ChatHandler::HandleTransportGoCommand,         "", nullptr },
        { "start",          SEC_ADMINISTRATOR,  false, &ChatHandler::HandleTransportStartCommand,      "", nullptr },
        { "stop",           SEC_ADMINISTRATOR,  false, &ChatHandler::HandleTransportStopCommand,       "", nullptr },
        { "",               SEC_ADMINISTRATOR,  false, &ChatHandler::HandleTransportCommand,           "", nullptr },
        { nullptr,             0,                  false, nullptr,                                           "", nullptr }
    };
    ...
    static ChatCommand modifyCommandTable[] =
    {
        ...
        { "powertype",      SEC_ADMINISTRATOR,  false, &ChatHandler::HandleModifyPowerTypeCommand,     "", nullptr },
    ...
    static ChatCommand reloadCommandTable[] =
    {
        ...
        { "worldstate",                  SEC_ADMINISTRATOR, true,  &ChatHandler::HandleWorldStateReloadCommand,              "", nullptr },
        { "spell_dbc",                   SEC_ADMINISTRATOR, true,  &ChatHandler::HandleReloadSpellDbcCommand,                "", nullptr },
    ...
    static ChatCommand wpCommandTable[] =
    {
        ...
        { "import",         SEC_ADMINISTRATOR,  false, &ChatHandler::HandleWpImportCommand,            "", nullptr },
        { nullptr,             0,                  false, nullptr,                                           "", nullptr }
    };
    ...
    static ChatCommand commandTable[] =
    {
        ...
        { "nameannounce",   SEC_MODERATOR,      false, &ChatHandler::HandleNameAnnounceCommand,        "", nullptr },
        ...
        { "ws",             SEC_GAMEMASTER,     false, nullptr,                                           "", WSCommandTable },
        { "transport",      SEC_ADMINISTRATOR,  false, nullptr,                                           "", transportCommandTable },
