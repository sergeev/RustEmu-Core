        ...
        switch (uEntry)
        {
            case NPC_DARK_RUNE_PROTECTOR:
            {
                ...
                for (uint8 i = 0; i < uiSpawnNumber; ++i)
                    pStalker->CastSpell(pStalker, SPELL_SUMMON_PROTECTOR, true, nullptr, nullptr, m_creature->GetObjectGuid());
                pStalker->CastSpell(pStalker, SPELL_SUMMON_STORMCALLER, true, nullptr, nullptr, m_creature->GetObjectGuid());
                break;
            }
            ...
            case NPC_IRON_GOLEM_CUSTODIAN:
            {
                ...
                pStalker->CastSpell(pStalker, SPELL_SUMMON_CUSTODIAN, true, nullptr, nullptr, m_creature->GetObjectGuid());
                break;
            }
        }
    }
