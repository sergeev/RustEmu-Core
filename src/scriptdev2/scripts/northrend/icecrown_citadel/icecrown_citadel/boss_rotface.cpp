...
// Rotface
struct boss_rotfaceAI : public base_icc_bossAI
{
...
struct mob_rotface_ooze_dummyAI : public ScriptedAI
{
...
struct mob_ooze_explosion_stalkerAI : public ScriptedAI
{
...
struct mob_sticky_oozeAI : public ScriptedAI
{
