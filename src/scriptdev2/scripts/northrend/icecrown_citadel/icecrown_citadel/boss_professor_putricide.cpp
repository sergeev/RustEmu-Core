 ...
 */
struct boss_professor_putricideAI : public base_icc_bossAI
{
 ...
 * mob_icc_gas_cloud
 */
struct mob_icc_gas_cloudAI : public base_icc_bossAI
{
 ...
 */
struct mob_icc_volatile_oozeAI : public base_icc_bossAI
{
...
struct mob_choking_gas_bombAI : public ScriptedAI
{
...
// passive mob AI struct
struct mob_ooze_puddleAI : public ScriptedAI
{
...
struct mob_mutated_amobinationAI : public ScriptedAI
{
