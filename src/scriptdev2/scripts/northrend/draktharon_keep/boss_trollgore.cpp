    ...
    void DoSummonDrakkariInvaders()
    {
        ...
        if (roll_chance_i(30))
        {
            ...
            if (Creature* pTrigger = m_creature->GetMap()->GetCreature(m_pInstance->GetTrollgoreCornerTrigger()))
                pTrigger->CastSpell(pTrigger, roll_chance_i(20) ? SPELL_SUMMON_INVADER_1 : SPELL_SUMMON_INVADER_2, true, nullptr, nullptr, m_creature->GetObjectGuid());
            ...
            if (Creature* pTrigger = m_creature->GetMap()->GetCreature(m_vTriggers[uiPos1]))
                pTrigger->CastSpell(pTrigger, roll_chance_i(30) ? SPELL_SUMMON_INVADER_1 : SPELL_SUMMON_INVADER_2, true, nullptr, nullptr, m_creature->GetObjectGuid());
